 ...
 * Generated at: 2023-11-29 22:48:08 UTC
...
public final class selectColumns_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/C:/Users/perez/OneDrive/Documentos/CLINICA-UAM/target/CLINICA/WEB-INF/lib/jstl-1.2.jar!/META-INF/fmt-1_0.tld", Long.valueOf(1153406682000L));
    ...
    _jspx_dependants.put("jar:file:/C:/Users/perez/OneDrive/Documentos/CLINICA-UAM/target/CLINICA/WEB-INF/lib/jstl-1.2.jar!/META-INF/c-1_0.tld", Long.valueOf(1153406682000L));
  }
...
for (Iterator it=tab.getColumnsToAdd().iterator(); it.hasNext();) { 
	...
	if (tab.isColumnsToAddUntilSecondLevel() && c > 20) break;
      ...
      try {
        ...
        // /xava/editors/selectColumns.jsp(47,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005faction_005f0.setAction("AddColumns.addColumn");
        // /xava/editors/selectColumns.jsp(47,2) name = argv type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /xava/editors/selectColumns.jsp(53,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005flink_005f0.setAction("AddColumns.addColumn");
        // /xava/editors/selectColumns.jsp(53,2) name = argv type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (tab.isColumnsToAddUntilSecondLevel()) {
      ...
      try {
        ...
        // /xava/editors/selectColumns.jsp(69,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005flink_005f1.setAction("AddColumns.showMoreColumns");
        // /xava/editors/selectColumns.jsp(69,0) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
tab.setColumnsToAddUntilSecondLevel(originalColumnsToAddUntilSecondLevel);
  ...
  private boolean _jspx_meth_xava_005fid_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /xava/editors/selectColumns.jsp(50,31) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
